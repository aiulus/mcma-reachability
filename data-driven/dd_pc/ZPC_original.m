...
W = zonotope([zeros(dim_x,1),w_spread_factor*ones(dim_x,1)]);
...
%measurement noise
v_spread_factor = 0.002; % controlls measurement noise levels
V = zonotope([zeros(dim_x,1),v_spread_factor*ones(dim_x,1)]);
